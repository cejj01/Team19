...
<div/>
<button class = "hyper-button" id="record-a-call-button"><u>Record a call</u></button>
...
<textarea id="solution-text-area" name="solution" rows="10" style ="resize: none;"></textarea>
</td>
</table>
<br>
<br>
